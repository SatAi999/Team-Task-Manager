...
const Sidebar = ({ open, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-30 h-full w-64 bg-slate-900 flex flex-col transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 overflow-y-auto">
          ...
          {isAdmin && (
            <>
              <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider px-3 mb-2 mt-5">Admin</p>
              <NavLink
                to="/projects/new"
                onClick={onClose}
                className={({ isActive }) =>
